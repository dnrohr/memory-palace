...
4. Broaden Qwen and BGE local-model QA beyond Settings probes, including repeated runs, memory use, fallback/recovery behavior, embedding rebuild/search latency, and structured-output quality.
