...
Remaining:
- Device QA for biometric app lock, import preview/apply with selected artifacts, and archive-at-rest unlock/migration paths.
...
Current prototype read: the typed-memory path meets this definition locally and has Pixel 8a evidence for the revised New memory/save flow, share-sheet export handoff, import handoff, and PIN app lock. Voice capture, biometric app lock, import preview/apply, optional local model assets, and sync still need fuller target-device QA before the app should be treated as broadly hardened.
...
4. Run import preview/apply QA with selected JSON and Markdown artifacts, biometric app-lock QA, and archive-at-rest migration/unlock QA on Pixel 8a.
